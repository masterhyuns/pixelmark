/**
 * E-S6 Wedding Classic — D-day 카운트다운
 * - [data-wc-countdown] 셀렉터로 격리
 */
export const initCountdown = (root: HTMLElement | Document = document): (() => void) => {
  if (typeof window === "undefined") return () => {}

  const container = root.querySelector<HTMLElement>("[data-wc-countdown]")
  if (!container) return () => {}
