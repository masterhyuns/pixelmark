...
const STATIC_ROUTES: Array<{ path: string; priority: string; changefreq: string }> = [
  ...
  { path: "/demos/living-modern", priority: "0.7", changefreq: "monthly" },
  { path: "/demos/bakery-pastel", priority: "0.7", changefreq: "monthly" },
  { path: "/demos/winebar-darklux", priority: "0.7", changefreq: "monthly" },
  { path: "/demos/winebar-darklux/menu", priority: "0.6", changefreq: "monthly" },
  { path: "/demos/winebar-darklux/reservation", priority: "0.6", changefreq: "monthly" },
  { path: "/demos/finedining-mono", priority: "0.7", changefreq: "monthly" },
  { path: "/demos/photographer-mono", priority: "0.7", changefreq: "monthly" },
  { path: "/demos/illustrator-vivid", priority: "0.7", changefreq: "monthly" },
  { path: "/demos/coach-warm", priority: "0.7", changefreq: "monthly" },
  { path: "/demos/coach-warm/programs", priority: "0.6", changefreq: "monthly" },
  { path: "/demos/coach-warm/contact", priority: "0.6", changefreq: "monthly" },
  { path: "/demos/medical-clean", priority: "0.7", changefreq: "monthly" },
